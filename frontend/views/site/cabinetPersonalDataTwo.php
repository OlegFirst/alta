<?php	
	...
	$cabinetMenuView = new CabinetMenuView('personalDataTwo');
?>
            ...
            <div class="col-xl-9">
                ...
                <div class="profile-type__wrap">
                    ...
                    <label class="profile-type">
                        ...
                        <span>ФОП ОЛІЙНИК С.В.</span>
                    </label>
                    <label class="profile-type">
                        <input type="radio" name="2">
                        <span>АВТО-СТРОЙ ЛИМИТЕД</span>
                    </label>
                    <label class="profile-type">
                        <input type="radio" name="2">
                        <span>МЕТИЗ ДОМ</span>
                ...
                <form action="">
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="input__wrap">
                                <input type="text" class="input__standart" placeholder="Ім'я" id="form2_1">
                                <label for="form2_1" class="input__title">
                                    Ім’я
                                </label>
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="input__wrap">
                                <input type="text" class="input__standart" placeholder="Прізвище" id="form2_2">
                                <label for="form2_2" class="input__title">
                                    Прізвище
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="input__wrap">
                                <input type="date" class="input__standart" placeholder="" id="form2_3">
                                <label for="form2_3" class="input__title">
                                    Дата народження
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="input__wrap">
                                <input type="tel" class="input__standart" placeholder="+38_ (__) ___-__-__" id="form2_4">
                                <label for="form2_4" class="input__title">
                                    Телефон
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="input__wrap">
                                <input type="text" class="input__standart" placeholder="email@email.com38" id="form2_5">
                                <label for="form2_5" class="input__title">
                                    Email
                                </label>
                            </div>
                        </div>
