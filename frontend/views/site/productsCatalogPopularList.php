            ...
            <div class="col-xl-9">
                ...
                <div class="line-filter mb-s">
                    <div class="line-filter__top">
                        ...
                        <div class="line-filter__top-type">
                            ...
                            <a href="#" class="line-filter__top-type-a">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="category-list2__wrap">
                    ...
                    <div class="good-list__before">
                        ...
                        <div class="good-list__before-buy">
                    ...
                    <?php for ($i = 0; $i < 12; $i++) { ?>
                        <?php include '_blocks/good-list.php'; ?>
                    <?php } ?>


                </div>
                <div class="category-list2__after">
                    <div class="category-list2__after-info">
                        <div class="circle__active"></div>
                        <span>В наявності</span>
                    </div>
                    <div class="category-list2__after-info">
                        <div class="circle__to-end"></div>
                        <span>Закінчується</span>
                    </div>
                    <div class="category-list2__after-info">
                        <div class="circle__inactive"></div>
                        <span>Немає на складі</span>
                    </div>
                </div>

                <ul class="pagination mt-s">
