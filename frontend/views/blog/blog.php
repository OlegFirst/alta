    ...
    <div class="container">
        ...
        <div class="row">
            <?php 
				...
				<div class="pagination-wrapper mt-s mb-m">
					<?php echo LinkPager::widget([ 
						'pagination' => $pagination,
						'pageCssClass' => 'pagination-item',
						'prevPageCssClass' => 'pagination-item pagination-item-prev',
						'nextPageCssClass' => 'pagination-item pagination-item-next',
						'maxButtonCount' => 3,
						'prevPageLabel' => '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
						...
						'nextPageLabel' => '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
