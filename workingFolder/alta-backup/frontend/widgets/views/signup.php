        ...
        <div class="modal-content">
            <div class="modal-block">						
							 <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
									...
									<div class="modal-login__form-legal" id="modal-login__form-legal">
										<?php 
											echo $form->field($model, 'companyName', [
												'inputOptions' => ['autofocus' => 'autofocus', 'class' => 'modal-login__form-input']
												])->textInput(['placeholder' => 'Назва компанії', 'value' => ''])->label(false);
											...
											echo $form->field($model, 'companyInfo')->textInput(['autofocus' => 'autofocus', 'class' => 'modal-login__form-input', 'placeholder' => 'ЄДРПОУ', 'value' => ''])->label(false);
									...
									<div class="modal-login__form-checkbox">											
											<?= Html::textInput('privacy_policy', '', array(
												'id' => 'checkbox3333', 'type' => 'checkbox'
											)) ?>
